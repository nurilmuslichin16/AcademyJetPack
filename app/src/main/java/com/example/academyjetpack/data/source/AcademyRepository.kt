...
import com.example.academyjetpack.data.source.remote.ApiResponse
...
class AcademyRepository private constructor(
    ...
    companion object {
        ...
        fun getInstance(remoteData: RemoteDataSource, loadData: LocalDataSource, appExecutors: AppExecutors): AcademyRepository =
            instance ?: synchronized(this) {
                instance ?: AcademyRepository(remoteData, loadData, appExecutors)
            }
    }
